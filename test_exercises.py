...
TESTS = {
    ...
    "exercise_02_age.py": {
        "type": "io",
        "inputs": [["Alice", 12], ["Bob", 42]],
        "outputs": ["Hello, Alice! You are 12 years old.", "Hello, Bob! You are 42 years old."]
    },
        ...
        "test_cases": [
            {
                "init_args": (),
                "methods": [
                    {"name": "increment", "args": (), "expected": None},
                    {"name": "get_value", "args": (), "expected": 1}
                ]
            },
            {
                "init_args": (10,),
                "methods": [
                    {"name": "increment", "args": (), "expected": None},
                    {"name": "increment", "args": (), "expected": None},
                    {"name": "get_value", "args": (), "expected": 12}
                ]
            }
        ]
    }
