...
_Lesson 2 through 9 are a quick recap of programming skills from IGCSE Computer Science. Those confident with their IGCSE programming can do a mini project to refresh their Python and demonstrate their competency with these skills in lieu of the exercises in these lessons_
...
## Lesson 4,5: Static & dynamic structures; Arrays & lists
...
## Lesson 9: Functions & modularisation
