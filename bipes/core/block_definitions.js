...
Blockly.Blocks['neopixel_s3_onboard'] = {
  init: function() {
    this.setColour(135);
    this.appendDummyInput()
        .appendField("Init Onboard RGB LED (GPIO48)");
    this.appendDummyInput()
        .appendField("ESP32-S3 DevKitC-1 NeoPixel on pin 48");
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip("Initialize the onboard NeoPixel RGB LED on GPIO48 (ESP32-S3-DevKitC-1). Use neopixel_control[0] and neopixel_write to set color.");
  }
};
